...
def load_data(prop, path, label_col, categories):
    ...
    # SPLIT & PREPARE
    trn_txt, trn_lbl = (trn.review.tolist(), trn[label_col].tolist())
    val_txt, val_lbl = (val.review.tolist(), val[label_col].tolist())
    tst_txt, tst_lbl = (tst.review.tolist(), tst[label_col].tolist())
