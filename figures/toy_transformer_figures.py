...
fig.savefig(f"figures/tt_lineplot.pdf", bbox_inches='tight', pad_inches=0., transparent=True)
fig.savefig(f"figures/tt_lineplot.png", bbox_inches='tight', pad_inches=0.)
plt.close()
